...
<body onload="viewData()" style="background:url(tlo.jpg) ;background-repeat:no-repeat;background-size:100% 100%;background-attachment: fixed">
        ...
        <header>  
           ...
           <li class="Uzytkownicy"><a href="Uzytkownicy.html"><span>Zarzadzaj Użytkownikami</span></a></li>
    ...
    function tableData(){
        $('#tabledit').Tabledit({
            ...
            columns: {
                identifier: [0, 'room'],
                editable: [[1, 'equipment'],[2, 'status', '{"0": "To do", "1": "Doing", "2": "Done"}'],[3, 'user'], [4, 'priority', '{"0": "Low", "1": "Medium", "2": "High"}'], [5, 'description']]
            },
