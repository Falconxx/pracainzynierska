...
$id=$_SESSION['id'];
$sql="SELECT * FROM list_of_order where (status='2' or status='3') AND house_id=$houses_id";
...
<br/>
    ...
    <header>  
       ...
       <h1>Polanka</h1>
        ...
        <option selected ="selected" value="HistoryOfOrders.php">History Of Orders</option>
