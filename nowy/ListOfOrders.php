...
$id=$_SESSION['id'];
$sql="SELECT * FROM list_of_order where (status!='2' AND status!='3') AND house_id=$houses_id";
...
<br/>
    ...
    <header>  
       ...
       <h1>Polanka</h1>
        ...
        <option selected="selected" value="ListOfOrders.php">List Of Orders</option>
