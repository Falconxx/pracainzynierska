...
window.cookieconsent.initialise({
  ...
  "static": true,
    ...
    <form class="form" action="zaloguj.php" method="post">
        ...
        <input type="password" class="input" placeholder="Password" name="haslo">
        <a style="margin-top:-15px;text-align: right;float: right;" href="reminder.php">Forgotten password?</a><br/>
