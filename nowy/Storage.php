        ...
        <table id="tabledit"  class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <input id="btnshow1" onclick="demoHide1()" style="display:none;" class="btn btn-info" type="button" value="Show Item"/>
                    <th>Item name <input id="btnHide1" onclick="demoShow1()" class="btn btn-success" type="button" value="Hide Items"/></th>
                    <input id="btnshow2" onclick="demoHide2()" style="display:none;" class="btn btn-info" type="button" value="Show Quantity"/>
                    <th>Quantity <input id="btnHide2" onclick="demoShow2()" class="btn btn-success" type="button" value="Hide Quantity"/></th>
                    <input id="btnshow3" onclick="demoHide3()" style="display:none;" class="btn btn-info" type="button" value="Show Requests"/>
                    <th>Number Of Requests<input id="btnHide3" onclick="demoShow3()" class="btn btn-success" type="button" value="Hide Requests"/></th>
                    <input id="btnshow4" onclick="demoHide4()" style="display:none;" class="btn btn-info" type="button" value="Show Weights"/>
                    <th>Weight <input id="btnHide4" onclick="demoShow4()" class="btn btn-success" type="button" value="Hide Weights"/></th>
                    <input id="btnshow5" onclick="demoHide5()" style="display:none;" class="btn btn-info" type="button" value="Show Prices"/>
                    <th>Price <input id="btnHide5" onclick="demoShow5()"  class="btn btn-success" type="button" value="Hide Prices"/></th>
                </tr>
            </thead>
            <tbody></tbody>
        </table>
